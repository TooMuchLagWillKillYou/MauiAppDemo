...
import {
  ...
  useTabsList,
  valueToPercent
} from "./chunk-RM7A454J.js";
import {
  CssBaseline_default,
  GlobalStyles_default
} from "./chunk-NZSDOL3G.js";
import "./chunk-U6GQ4ZSJ.js";
import {
...
var NestedListContext = React2.createContext(false);
if (true) {
...
var ComponentListContext = React4.createContext(void 0);
if (true) {
...
var ListSubheaderContext = React5.createContext(void 0);
if (true) {
...
var GroupListContext = React6.createContext(void 0);
if (true) {
...
var ListItem = React7.forwardRef(function ListItem2(inProps, ref) {
  ...
  const listComponent = React7.useContext(ComponentListContext_default);
  const row = React7.useContext(RowListContext_default);
  const wrap = React7.useContext(WrapListContext_default);
  ...
  const [subheaderId, setSubheaderId] = React7.useState("");
  ...
  return (0, import_jsx_runtime.jsx)(ListSubheaderContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime.jsx)(NestedListContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime.jsxs)(SlotRoot, _extends({}, rootProps, {
        ...
        })), React7.Children.map(children, (child, index) => React7.isValidElement(child) ? React7.cloneElement(child, _extends({}, index === 0 && {
          "data-first-child": ""
...
var Accordion = React8.forwardRef(function Accordion2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyAccordion"
  });
  ...
  const handleChange = React8.useCallback((event) => {
  ...
  return (0, import_jsx_runtime2.jsx)(AccordionContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime2.jsx)(SlotRoot, _extends({}, rootProps, {
      children: React8.Children.map(children, (child, index) => React8.isValidElement(child) && index === 0 ? React8.cloneElement(child, {
...
function ListProvider(props) {
  ...
  const baseProviders = (0, import_jsx_runtime4.jsx)(RowListContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime4.jsx)(WrapListContext_default.Provider, {
      value: wrap,
      children: React10.Children.map(children, (child, index) => React10.isValidElement(child) ? React10.cloneElement(child, _extends({}, index === 0 && {
        "data-first-child": ""
      }, index === React10.Children.count(children) - 1 && {
        "data-last-child": ""
      })) : child)
    })
  });
...
var List = React12.forwardRef(function List2(inProps, ref) {
  const nesting = React12.useContext(NestedListContext_default);
  const group = React12.useContext(GroupListContext_default);
  const radioGroupContext = React12.useContext(RadioGroupContext_default);
  const props = useThemeProps({
    props: inProps,
    name: "JoyList"
  });
...
var AccordionGroup = React13.forwardRef(function AccordionGroup2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyAccordionGroup"
  });
...
var _excluded6 = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox", "size", "slots", "slotProps"];
...
var SvgIconRoot = styled_default("svg", {
  ...
  return _extends({}, ownerState.instanceSize && {
    ...
    color: `rgba(${(_a = theme.vars.palette[ownerState.color]) == null ? void 0 : _a.mainChannel} / 1)`
  }));
});
...
true ? SvgIcon.propTypes = {
   ...
   */
  color: import_prop_types6.default.oneOfType([import_prop_types6.default.oneOf(["danger", "inherit", "neutral", "primary", "success", "warning"]), import_prop_types6.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   */
  fontSize: import_prop_types6.default.oneOfType([import_prop_types6.default.oneOf(["inherit", "lg", "md", "sm", "xl", "xl2", "xl3", "xl4", "xs"]), import_prop_types6.default.string]),
  /**
...
var KeyboardArrowDown_default = createSvgIcon((0, import_jsx_runtime9.jsx)("path", {
...
var AccordionSummary = React17.forwardRef(function AccordionSummary2(inProps, ref) {
  ...
  const {
    ...
    color = "neutral",
    children,
    indicator = _KeyboardArrowDown || (_KeyboardArrowDown = (0, import_jsx_runtime10.jsx)(KeyboardArrowDown_default, {})),
    variant = "plain",
    slots = {},
    slotProps = {}
  ...
  const handleClick = (event) => {
    ...
    if (typeof slotProps.button === "function") {
      (_b = (_a = slotProps.button(ownerState)) == null ? void 0 : _a.onClick) == null ? void 0 : _b.call(_a, event);
    } else {
      (_d = (_c = slotProps.button) == null ? void 0 : _c.onClick) == null ? void 0 : _d.call(_c, event);
    }
  };
  ...
  return (
    ...
    (0, import_jsx_runtime10.jsx)(SlotRoot, _extends({}, rootProps, {
      children: (0, import_jsx_runtime10.jsxs)(SlotButton, _extends({}, buttonProps, {
        children: [children, indicator && (0, import_jsx_runtime10.jsx)(SlotIndicator, _extends({}, indicatorProps, {
          children: indicator
        }))]
      }))
    }))
...
var AlertRoot = styled_default("div", {
  ...
  return [_extends({
    ...
    fontWeight: theme.vars.fontWeight.md
  }, ownerState.variant === "solid" && ownerState.color && ownerState.invertedColors && applySolidInversion(ownerState.color)(theme), ownerState.variant === "soft" && ownerState.color && ownerState.invertedColors && applySoftInversion(ownerState.color)(theme), (_a = theme.variants[ownerState.variant]) == null ? void 0 : _a[ownerState.color]), p !== void 0 && {
    "--Alert-padding": p
  }, padding !== void 0 && {
...
var AspectRatioContent = styled_default("div", {
  ...
  }, theme.typography["body-md"], (_a = theme.variants[ownerState.variant]) == null ? void 0 : _a[ownerState.color]);
});
var AspectRatio = React19.forwardRef(function AspectRatio2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyAspectRatio"
  });
  ...
  return (0, import_jsx_runtime12.jsx)(SlotRoot, _extends({}, rootProps, {
    children: (0, import_jsx_runtime12.jsx)(SlotContent, _extends({}, contentProps, {
      children: React19.Children.map(children, (child, index) => index === 0 && React19.isValidElement(child) ? React19.cloneElement(child, {
        "data-first-child": ""
      }) : child)
    }))
  }));
...
var VariantColorContext = React22.createContext(void 0);
if (true) {
...
function useVariantColor(instanceVariant, instanceColor, alwaysInheritColor = false) {
  const value = React22.useContext(VariantColorContext);
...
var ChipColorContext = React23.createContext({
  disabled: void 0,
  variant: void 0,
  color: void 0
});
...
var Chip = React24.forwardRef(function Chip2(inProps, ref) {
  ...
  const actionRef = React24.useRef(null);
  const {
    focusVisible,
    getRootProps
  ...
  const chipContextValue = React24.useMemo(() => ({
    disabled
  }), [disabled]);
...
var ChipDelete = React26.forwardRef(function ChipDelete2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyChipDelete"
  });
  ...
  const chipContext = React26.useContext(ChipContext_default);
  const {
    variant = variantProp,
  ...
  return (0, import_jsx_runtime18.jsx)(SlotRoot, _extends({}, restOfRootProps, {
    children: children ?? (_Cancel || (_Cancel = (0, import_jsx_runtime18.jsx)(Cancel_default, {})))
  }));
});
...
var ListSubheader = React30.forwardRef(function ListSubheader2(inProps, ref) {
  ...
  const setSubheaderId = React30.useContext(ListSubheaderContext_default);
  React30.useEffect(() => {
    if (setSubheaderId) {
      setSubheaderId(id || "");
    }
...
var AutocompleteListbox = React31.forwardRef(function AutocompleteListbox2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyAutocompleteListbox"
  });
  ...
  return (0, import_jsx_runtime21.jsx)(VariantColorProvider, {
    variant,
    color,
...
var defaultRenderGroup = (params) => (0, import_jsx_runtime23.jsxs)(ListItem_default, {
  nested: true,
...
var Autocomplete = React33.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  let popup = null;
  if (anchorEl) {
    popup = (0, import_jsx_runtime23.jsx)(VariantColorProvider, {
      variant,
      color,
      children: (0, import_jsx_runtime23.jsx)(ListProvider_default, {
        nested: true,
        children: (0, import_jsx_runtime23.jsxs)(SlotListbox, _extends({}, listboxProps, {
  ...
  return (0, import_jsx_runtime23.jsxs)(React33.Fragment, {
    children: [(0, import_jsx_runtime23.jsxs)(SlotRoot, _extends({}, rootProps, {
      children: [startDecorator && (0, import_jsx_runtime23.jsx)(SlotStartDecorator, _extends({}, startDecoratorProps, {
        children: startDecorator
      })), (0, import_jsx_runtime23.jsxs)(SlotWrapper, _extends({}, wrapperProps, {
...
var AvatarGroupContext = React35.createContext(void 0);
if (true) {
...
var AvatarGroup = React35.forwardRef(function AvatarGroup2(inProps, ref) {
  ...
  const ownerState = React35.useMemo(() => _extends({}, props, {
    color,
    component,
    size,
    variant
  ...
  return (0, import_jsx_runtime25.jsx)(AvatarGroupContext.Provider, {
    value: ownerState,
...
var Avatar = React36.forwardRef(function Avatar2(inProps, ref) {
  ...
  const groupContext = React36.useContext(AvatarGroupContext);
  const {
    alt,
    color: colorProp = "neutral",
    size: sizeProp = "md",
  ...
  if (hasImgNotFailing) {
    children = (0, import_jsx_runtime26.jsx)(SlotImg, _extends({}, imageProps));
  } else if (childrenProp != null) {
    children = childrenProp;
  } else if (alt) {
    children = alt[0];
  } else {
    children = (0, import_jsx_runtime26.jsx)(SlotFallback, _extends({}, fallbackProps));
  }
...
var BadgeBadge = styled_default("span", {
  ...
  const translateY = ((_a = ownerState.anchorOrigin) == null ? void 0 : _a.vertical) === "top" ? "translateY(-50%)" : "translateY(50%)";
  const translateX = ((_b = ownerState.anchorOrigin) == null ? void 0 : _b.horizontal) === "left" ? "translateX(-50%)" : "translateX(50%)";
  const transformOriginY = ((_c = ownerState.anchorOrigin) == null ? void 0 : _c.vertical) === "top" ? "0%" : "100%";
  const transformOriginX = ((_d = ownerState.anchorOrigin) == null ? void 0 : _d.horizontal) === "left" ? "0%" : "100%";
  ...
  return _extends({
    "--Icon-color": "currentColor",
    "--Icon-fontSize": `calc(1em * ${(typography == null ? void 0 : typography.lineHeight) ?? "1"})`,
    display: "inline-flex",
    flexWrap: "wrap",
    justifyContent: "center",
    alignContent: "center",
    ...
    fontWeight: theme.vars.fontWeight.md
  }, (_e = theme.variants[ownerState.variant]) == null ? void 0 : _e[ownerState.color]);
});
var Badge = React37.forwardRef(function Badge2(inProps, ref) {
  ...
  return (0, import_jsx_runtime27.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [children, (0, import_jsx_runtime27.jsx)(SlotBadge, _extends({}, badgeProps, {
...
var TypographyNestedContext = React38.createContext(false);
if (true) {
  TypographyNestedContext.displayName = "TypographyNestedContext";
}
var TypographyInheritContext = React38.createContext(false);
if (true) {
...
var Typography = React38.forwardRef(function Typography2(inProps, ref) {
  ...
  return (0, import_jsx_runtime28.jsx)(TypographyNestedContext.Provider, {
    value: true,
    children: (0, import_jsx_runtime28.jsxs)(SlotRoot, _extends({}, rootProps, {
      children: [startDecorator && (0, import_jsx_runtime28.jsx)(SlotStartDecorator, _extends({}, startDecoratorProps, {
        children: startDecorator
      })), hasSkeleton ? React38.cloneElement(children, {
        variant: children.props.variant || "inline"
      }) : children, endDecorator && (0, import_jsx_runtime28.jsx)(SlotEndDecorator, _extends({}, endDecoratorProps, {
        children: endDecorator
      }))]
    }))
  });
...
var Breadcrumbs = React39.forwardRef(function Breadcrumbs2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyBreadcrumbs"
  });
  ...
  const allItems = React39.Children.toArray(children).filter((child) => {
    return React39.isValidElement(child);
  }).map((child, index) => (0, import_jsx_runtime29.jsx)(SlotLi, _extends({}, liProps, {
    children: isMuiElement(child, ["Typography"]) ? React39.cloneElement(child, {
      component: child.props.component ?? "span"
    }) : child
  }), `child-${index}`));
  return (0, import_jsx_runtime29.jsx)(TypographyInheritContext.Provider, {
    value: true,
    children: (0, import_jsx_runtime29.jsx)(SlotRoot, _extends({}, rootProps, {
      children: (0, import_jsx_runtime29.jsx)(SlotOl, _extends({}, olProps, {
        children: allItems.reduce((acc, current, index) => {
          if (index < allItems.length - 1) {
            acc = acc.concat(current, (0, import_jsx_runtime29.jsx)(SlotSeparator, _extends({}, separatorProps, {
              children: separator
            }), `separator-${index}`));
          } else {
            acc.push(current);
...
var Button = React40.forwardRef(function Button2(inProps, ref) {
  ...
  const buttonGroup = React40.useContext(ButtonGroupContext_default);
  const toggleButtonGroup = React40.useContext(ToggleButtonGroupContext_default);
  ...
  return (0, import_jsx_runtime30.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(startDecorator || loading && loadingPosition === "start") && (0, import_jsx_runtime30.jsx)(SlotStartDecorator, _extends({}, startDecoratorProps, {
      children: loading && loadingPosition === "start" ? loadingIndicator : startDecorator
    })), children, loading && loadingPosition === "center" && (0, import_jsx_runtime30.jsx)(SlotLoadingIndicatorCenter, _extends({}, loadingIndicatorCenterProps, {
      children: loadingIndicator
    })), (endDecorator || loading && loadingPosition === "end") && (0, import_jsx_runtime30.jsx)(SlotEndDecorator, _extends({}, endDecoratorProps, {
  ...
  traverseBreakpoints(theme.breakpoints, ownerState.spacing, (appendStyle, value) => {
    ...
    if (value !== null) {
      appendStyle(styles, {
        ...
        gap: typeof value === "string" ? value : (_a2 = theme.spacing) == null ? void 0 : _a2.call(theme, value)
      });
    }
  });
  const outlinedStyle = (_a = theme.variants.outlined) == null ? void 0 : _a[ownerState.color];
  const outlinedDisabledStyle = (_b = theme.variants.outlinedDisabled) == null ? void 0 : _b[ownerState.color];
  const outlinedHoverStyle = (_c = theme.variants.outlinedHover) == null ? void 0 : _c[ownerState.color];
  return [_extends({
...
var ButtonGroup = React41.forwardRef(function ButtonGroup2(inProps, ref) {
  ...
  const buttonGroupContext = React41.useMemo(() => ({
    variant,
    color,
    size,
    disabled
  ...
  return (0, import_jsx_runtime31.jsx)(SlotRoot, _extends({}, rootProps, {
    children: (0, import_jsx_runtime31.jsx)(ButtonGroupContext_default.Provider, {
      ...
      children: React41.Children.map(children, (child, index) => {
        ...
        if (React41.Children.count(children) > 1) {
          ...
          if (index === React41.Children.count(children) - 1) {
            extraProps["data-last-child"] = "";
          }
        }
        return React41.cloneElement(child, extraProps);
      })
    })
  }));
});
...
var StyledCardActionsRoot = styled_default("div")(({
  ...
  return _extends({
    ...
    display: "flex"
  }, ((_a = ownerState.orientation) == null ? void 0 : _a.startsWith("horizontal")) && {
    alignItems: "center"
...
var CardCover = React45.forwardRef(function CardCover2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyCardCover"
  });
  ...
  return (0, import_jsx_runtime35.jsx)(SlotRoot, _extends({}, rootProps, {
    children: React45.Children.map(children, (child, index) => index === 0 && React45.isValidElement(child) ? React45.cloneElement(child, {
      "data-first-child": ""
    }) : child)
  }));
});
...
var CardOverflow = React46.forwardRef(function CardOverflow2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyCardOverflow"
  });
...
var Check_default = createSvgIcon((0, import_jsx_runtime37.jsx)("path", {
...
var HorizontalRule_default = createSvgIcon((0, import_jsx_runtime38.jsx)("path", {
...
var CheckboxCheckbox = styled_default("span", {
  ...
  return [_extends({
    ...
    [`&.${checkboxClasses_default.disabled}`]: (_d = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _d[ownerState.color]
  }] : []];
});
var CheckboxAction = styled_default("span", {
  ...
  return [{
    ...
    "&:hover": (_b = theme.variants[`${ownerState.variant}Hover`]) == null ? void 0 : _b[ownerState.color]
  }, {
    "&:active": (_c = theme.variants[`${ownerState.variant}Active`]) == null ? void 0 : _c[ownerState.color]
  }, {
    [`&.${checkboxClasses_default.disabled}`]: (_d = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _d[ownerState.color]
...
var defaultCheckedIcon = (0, import_jsx_runtime39.jsx)(Check_default, {});
var defaultIndeterminateIcon = (0, import_jsx_runtime39.jsx)(HorizontalRule_default, {});
var Checkbox = React49.forwardRef(function Checkbox2(inProps, ref) {
  ...
  const disabledProp = inProps.disabled ?? (formControl == null ? void 0 : formControl.disabled) ?? disabledExternalProp;
  const size = inProps.size ?? (formControl == null ? void 0 : formControl.size) ?? sizeProp;
  if (true) {
    const registerEffect = formControl == null ? void 0 : formControl.registerEffect;
    React49.useEffect(() => {
  ...
  const color = inProps.color || ((formControl == null ? void 0 : formControl.error) ? "danger" : (formControl == null ? void 0 : formControl.color) ?? colorProp);
  ...
  return (0, import_jsx_runtime39.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime39.jsxs)(SlotCheckbox, _extends({}, checkboxProps, {
      children: [(0, import_jsx_runtime39.jsx)(SlotAction, _extends({}, actionProps, {
        children: (0, import_jsx_runtime39.jsx)(SlotInput, _extends({}, inputProps))
      })), icon]
    })), label && (0, import_jsx_runtime39.jsx)(TypographyNestedContext.Provider, {
      value: true,
      children: (0, import_jsx_runtime39.jsx)(SlotLabel, _extends({}, labelProps, {
        children: label
      }))
    })]
  }));
...
var ModalDialogVariantColorContext = React51.createContext(void 0);
if (true) {
...
var DialogContent = React52.forwardRef(function DialogContent2(inProps, ref) {
  ...
  const context = React52.useContext(ModalDialogVariantColorContext_default);
  const {
    component = "div",
    children,
    orientation = "vertical",
...
var ModalDialogSizeContext = React53.createContext(void 0);
if (true) {
...
var CloseModalContext = React56.createContext(void 0);
if (true) {
...
var Modal = React57.forwardRef(function Modal2(inProps, ref) {
  ...
  return (0, import_jsx_runtime44.jsx)(CloseModalContext_default.Provider, {
    value: onClose,
    children: (0, import_jsx_runtime44.jsx)(Portal, {
      ref: portalRef,
      container,
      disablePortal,
      children: (0, import_jsx_runtime44.jsxs)(SlotRoot, _extends({}, rootProps, {
        children: [!hideBackdrop ? (0, import_jsx_runtime44.jsx)(SlotBackdrop, _extends({}, backdropProps)) : null, (0, import_jsx_runtime44.jsx)(FocusTrap, {
          disableEnforceFocus,
          disableAutoFocus,
          disableRestoreFocus,
          isEnabled: isTopModal,
          open,
          children: React57.Children.only(children) && React57.cloneElement(children, _extends({}, children.props.tabIndex === void 0 && {
            tabIndex: -1
          }))
        })]
      }))
...
var DrawerContent = styled_default("div", {
  ...
  }, ownerState.variant === "solid" && ownerState.color && ownerState.invertedColors && applySolidInversion(ownerState.color)(theme), ownerState.variant === "soft" && ownerState.color && ownerState.invertedColors && applySoftInversion(ownerState.color)(theme), (_a = theme.variants[ownerState.variant]) == null ? void 0 : _a[ownerState.color], {
...
var Drawer = React58.forwardRef(function Drawer2(inProps, ref) {
  ...
  return (0, import_jsx_runtime45.jsx)(CloseModalContext_default.Provider, {
    value: onClose,
    children: (0, import_jsx_runtime45.jsx)(ModalDialogSizeContext_default.Provider, {
      value: size,
      children: (0, import_jsx_runtime45.jsx)(ModalDialogVariantColorContext_default.Provider, {
        value: contextValue,
        children: (0, import_jsx_runtime45.jsx)(Portal, {
          ref: portalRef,
          container,
          disablePortal,
          children: (0, import_jsx_runtime45.jsxs)(SlotRoot, _extends({}, rootProps, {
            children: [!hideBackdrop ? (0, import_jsx_runtime45.jsx)(SlotBackdrop, _extends({}, backdropProps)) : null, (0, import_jsx_runtime45.jsx)(FocusTrap, {
              disableEnforceFocus,
              disableAutoFocus,
              disableRestoreFocus,
              isEnabled: isTopModal,
              open,
              children: (0, import_jsx_runtime45.jsx)(SlotContent, _extends({}, contentProps, {
                children
              }))
            })]
          }))
...
var FormControl = React59.forwardRef(function FormControl2(inProps, ref) {
  ...
  const id = useId(idOverride);
  const [helperText, setHelperText] = React59.useState(null);
  const ownerState = _extends({}, props, {
    id,
    component,
    color,
  ...
  const formControlContextValue = React59.useMemo(() => ({
    disabled,
    required,
    error,
    color,
...
var FormLabel = React61.forwardRef(function FormLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime48.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [children, required && (0, import_jsx_runtime48.jsxs)(SlotAsterisk, _extends({}, asteriskProps, {
      children: [" ", "*"]
    }))]
  }));
});
...
var progressKeyframe = keyframes`
  0% {
...
var LinearProgressRoot = styled_default("div", {
  ...
  return _extends({
    ...
    color: (_b = theme.variants.solid) == null ? void 0 : _b[ownerState.color].backgroundColor
  }, ownerState.variant === "solid" && {
    backgroundColor: (_c = theme.variants.softHover) == null ? void 0 : _c[ownerState.color].backgroundColor,
    color: (_d = theme.variants.solid) == null ? void 0 : _d[ownerState.color].backgroundColor
  });
}, ({
  ownerState
}) => ownerState.determinate ? {
...
var StartDecorator2 = styled_default("span", {
  ...
  }, typeof ownerState.startDecorator !== "string" && (ownerState.alignItems === "flex-start" || ((_a = ownerState.sx) == null ? void 0 : _a.alignItems) === "flex-start") && {
    marginTop: "2px"
...
var LinkRoot = styled_default("a", {
  ...
  return [_extends({
    ...
    cursor: "pointer",
    textDecorationColor: `var(--variant-outlinedBorder, rgba(${(_a = theme.vars.palette[ownerState.color]) == null ? void 0 : _a.mainChannel} / var(--Link-underlineOpacity, 0.72)))`
  }, ownerState.variant ? _extends({
    paddingBlock: "min(0.1em, 4px)",
    paddingInline: "0.25em"
  }, !ownerState.nesting && {
    ...
    color: `var(--variant-plainColor, rgba(${(_b = theme.vars.palette[ownerState.color]) == null ? void 0 : _b.mainChannel} / 1))`,
    [`&.${linkClasses_default.disabled}`]: {
      pointerEvents: "none",
      color: `var(--variant-plainDisabledColor, rgba(${(_c = theme.vars.palette[ownerState.color]) == null ? void 0 : _c.mainChannel} / 0.6))`
    }
  }, {
    ...
    position: "relative",
    [theme.focus.selector]: theme.focus.default
  }), ownerState.variant && _extends({}, (_d = theme.variants[ownerState.variant]) == null ? void 0 : _d[ownerState.color], {
    "&:hover": {
      "@media (hover: hover)": (_e = theme.variants[`${ownerState.variant}Hover`]) == null ? void 0 : _e[ownerState.color]
    },
    "&:active": (_f = theme.variants[`${ownerState.variant}Active`]) == null ? void 0 : _f[ownerState.color],
    [`&.${linkClasses_default.disabled}`]: (_g = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _g[ownerState.color]
  })];
});
var Link = React63.forwardRef(function Link2(inProps, ref) {
  ...
  return (0, import_jsx_runtime50.jsx)(TypographyNestedContext.Provider, {
    value: true,
    children: (0, import_jsx_runtime50.jsxs)(SlotRoot, _extends({}, rootProps, {
      children: [startDecorator && (0, import_jsx_runtime50.jsx)(SlotStartDecorator, _extends({}, startDecoratorProps, {
        children: startDecorator
      })), isMuiElement(children, ["Skeleton"]) ? React63.cloneElement(children, {
        variant: children.props.variant || "inline"
      }) : children, endDecorator && (0, import_jsx_runtime50.jsx)(SlotEndDecorator, _extends({}, endDecoratorProps, {
        children: endDecorator
      }))]
    }))
  });
...
var MenuRoot = styled_default(StyledList, {
  ...
  return [_extends({
    ...
    backgroundColor: theme.vars.palette.background.popup
  }, ownerState.variant === "solid" && ownerState.color && ownerState.invertedColors && applySolidInversion(ownerState.color)(theme), ownerState.variant === "soft" && ownerState.color && ownerState.invertedColors && applySoftInversion(ownerState.color)(theme), (_b = theme.variants[ownerState.variant]) == null ? void 0 : _b[ownerState.color])];
});
var Menu = React67.forwardRef(function Menu2(inProps, ref) {
  ...
  return (0, import_jsx_runtime54.jsx)(MenuRoot, _extends({}, rootProps, !((_a = props.slots) == null ? void 0 : _a.root) && {
    as: Popper,
    slots: {
      root: component || "ul"
    }
...
var MenuButton = React68.forwardRef(function MenuButton2(inProps, forwardedRef) {
  ...
  return (0, import_jsx_runtime55.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(startDecorator || loading && loadingPosition === "start") && (0, import_jsx_runtime55.jsx)(SlotStartDecorator, _extends({}, startDecoratorProps, {
      children: loading && loadingPosition === "start" ? loadingIndicator : startDecorator
    })), children, loading && loadingPosition === "center" && (0, import_jsx_runtime55.jsx)(SlotLoadingIndicatorCenter, _extends({}, loadingIndicatorCenterProps, {
      children: loadingIndicator
    })), (endDecorator || loading && loadingPosition === "end") && (0, import_jsx_runtime55.jsx)(SlotEndDecorator, _extends({}, endDecoratorProps, {
      children: loading && loadingPosition === "end" ? loadingIndicator : endDecorator
    }))]
  }));
});
...
var MenuItem = React69.memo(React69.forwardRef(function MenuItem2(inProps, ref) {
  ...
  return (0, import_jsx_runtime56.jsx)(ListItemButtonOrientationContext_default.Provider, {
    value: orientation,
...
var StableMenuItem = React69.forwardRef(function StableMenuItem2(props, ref) {
  ...
  return (0, import_jsx_runtime56.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime56.jsx)(MenuItem, _extends({}, props, {
      id,
      ref
    }))
  });
...
var MenuList = React70.forwardRef(function MenuList2(inProps, ref) {
  ...
  return (0, import_jsx_runtime57.jsx)(SlotRoot, _extends({}, rootProps, {
    children: (0, import_jsx_runtime57.jsx)(MenuProvider, {
...
var ModalCloseRoot = styled_default(StyledIconButton, {
  ...
  }, !((_b = (_a = theme.variants[ownerState.variant]) == null ? void 0 : _a[ownerState.color]) == null ? void 0 : _b.backgroundColor) && {
...
var ModalClose = React71.forwardRef(function ModalClose2(inProps, ref) {
  ...
  const variant = inProps.variant ?? modalDialogVariantMapping[modalDialogVariantColor == null ? void 0 : modalDialogVariantColor.variant] ?? variantProp;
  const color = inProps.color ?? (modalDialogVariantColor == null ? void 0 : modalDialogVariantColor.color) ?? colorProp;
...
function getBreakpointValue(theme, breakpoint) {
  var _a, _b;
  return breakpoint && ((_a = theme.breakpoints) == null ? void 0 : _a.values[breakpoint]) ? `${(_b = theme.breakpoints) == null ? void 0 : _b.values[breakpoint]}px` : breakpoint;
}
...
var ModalDialog = React72.forwardRef(function ModalDialog2(inProps, ref) {
  ...
  return (0, import_jsx_runtime59.jsx)(ModalDialogSizeContext_default.Provider, {
    value: size,
...
var OptionRoot = styled_default(StyledListItemButton, {
  ...
  var _a;
  const variantStyle = (_a = theme.variants[`${ownerState.variant}Hover`]) == null ? void 0 : _a[ownerState.color];
  return {
...
var Option = React74.memo(React74.forwardRef(function Option2(inProps, ref) {
  ...
  const computedLabel = label ?? (typeof children === "string" ? children : (_a = optionRef.current) == null ? void 0 : _a.innerText);
  const {
    getRootProps,
    selected,
    highlighted,
...
var StableOption = React74.forwardRef(function StableOption2(props, ref) {
  ...
  return (0, import_jsx_runtime61.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime61.jsx)(Option, _extends({}, props, {
      ref
    }))
  });
});
...
var _excluded58 = ["checked", "checkedIcon", "defaultChecked", "disabled", "disableIcon", "overlay", "label", "id", "name", "onBlur", "onChange", "onFocus", "onFocusVisible", "readOnly", "required", "color", "variant", "size", "uncheckedIcon", "value", "component", "slots", "slotProps"];
...
var Radio = React75.forwardRef(function Radio2(inProps, ref) {
  ...
  return (0, import_jsx_runtime62.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime62.jsxs)(SlotRadio, _extends({}, radioProps, {
      children: [checked && !disableIcon && checkedIcon, !checked && !disableIcon && uncheckedIcon, !checkedIcon && !uncheckedIcon && !disableIcon && (0, import_jsx_runtime62.jsx)(SlotIcon, _extends({}, iconProps)), (0, import_jsx_runtime62.jsx)(SlotAction, _extends({}, actionProps, {
        children: (0, import_jsx_runtime62.jsx)(SlotInput, _extends({}, inputProps))
      }))]
    })), label && (0, import_jsx_runtime62.jsx)(SlotLabel, _extends({}, labelProps, {
      children: (0, import_jsx_runtime62.jsx)(TypographyNestedContext.Provider, {
        value: true,
        children: label
      })
    }))]
...
var _excluded59 = ["className", "component", "children", "name", "defaultValue", "disableIcon", "overlay", "value", "onChange", "color", "variant", "size", "orientation", "role", "slots", "slotProps"];
...
var RadioGroup = React76.forwardRef(function RadioGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime63.jsx)(RadioGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime63.jsx)(SlotRoot, _extends({}, rootProps, {
      children: (0, import_jsx_runtime63.jsx)(FormControlContext_default.Provider, {
        value: void 0,
...
var _excluded60 = ["className", "component", "disableColorScheme", "slots", "slotProps"];
...
var _Unfold;
var _excluded61 = ["action", "autoFocus", "children", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "placeholder", "listboxId", "listboxOpen", "onChange", "onListboxOpenChange", "onClose", "renderValue", "required", "value", "size", "variant", "color", "startDecorator", "endDecorator", "indicator", "aria-describedby", "aria-label", "aria-labelledby", "id", "name", "multiple", "slots", "slotProps"];
function defaultRenderValue(selectedOptions) {
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime66.jsx)(React79.Fragment, {
      children: selectedOptions.map((o) => o.label).join(", ")
    });
  }
  return (selectedOptions == null ? void 0 : selectedOptions.label) ?? "";
}
...
var SelectRoot = styled_default("div", {
  ...
  return [_extends({
    ...
    "--Select-focusedHighlight": (_b = theme.vars.palette[ownerState.color === "neutral" ? "primary" : ownerState.color]) == null ? void 0 : _b[500],
    '&:not([data-inverted-colors="false"])': _extends({}, ownerState.instanceColor && {
      "--_Select-focusedHighlight": (_c = theme.vars.palette[ownerState.instanceColor === "neutral" ? "primary" : ownerState.instanceColor]) == null ? void 0 : _c[500]
    }, {
      "--Select-focusedHighlight": theme.vars.palette.focusVisible
    }),
    "--Select-indicatorColor": (variantStyle == null ? void 0 : variantStyle.backgroundColor) ? variantStyle == null ? void 0 : variantStyle.color : theme.vars.palette.text.tertiary
  }, ownerState.size === "sm" && {
    ...
    [`&.${selectClasses_default.disabled}`]: (_e = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _e[ownerState.color]
  }, borderRadius !== void 0 && {
...
var Select = React79.forwardRef(function Select2(inProps, ref) {
  ...
  const [SlotButton, buttonProps] = useSlot("button", {
    additionalProps: {
      "aria-describedby": ariaDescribedby ?? (formControl == null ? void 0 : formControl["aria-describedby"]),
      "aria-label": ariaLabel,
      "aria-labelledby": ariaLabelledby ?? (formControl == null ? void 0 : formControl.labelId),
  ...
  return (0, import_jsx_runtime66.jsxs)(React79.Fragment, {
    children: [(0, import_jsx_runtime66.jsxs)(SlotRoot, _extends({}, rootProps, {
      children: [startDecorator && (0, import_jsx_runtime66.jsx)(SlotStartDecorator, _extends({}, startDecoratorProps, {
        children: startDecorator
      })), (0, import_jsx_runtime66.jsx)(SlotButton, _extends({}, buttonProps, {
        children: displayValue
      })), endDecorator && (0, import_jsx_runtime66.jsx)(SlotEndDecorator, _extends({}, endDecoratorProps, {
        children: endDecorator
      })), indicator && (0, import_jsx_runtime66.jsx)(SlotIndicator, _extends({}, indicatorProps, {
        children: indicator
      })), (0, import_jsx_runtime66.jsx)("input", _extends({}, getHiddenInputProps()))]
    })), anchorEl && (0, import_jsx_runtime66.jsx)(SlotListbox, _extends({}, listboxProps, {
      className: clsx_default(listboxProps.className),
      modifiers
    }, !((_a = props.slots) == null ? void 0 : _a.listbox) && {
      as: Popper,
      ...
      children: (0, import_jsx_runtime66.jsx)(SelectProvider, {
        value: contextValue,
...
var _excluded62 = ["className", "color", "component", "variant", "invertedColors", "slots", "slotProps"];
...
var SheetRoot = styled_default("div", {
  ...
  return [_extends({
    ...
    backgroundColor: theme.vars.palette.background.surface,
    position: "relative"
  }), _extends({}, theme.typography["body-md"], ownerState.variant === "solid" && ownerState.color && ownerState.invertedColors && applySolidInversion(ownerState.color)(theme), ownerState.variant === "soft" && ownerState.color && ownerState.invertedColors && applySoftInversion(ownerState.color)(theme), (_b = theme.variants[ownerState.variant]) == null ? void 0 : _b[ownerState.color], variantStyle)];
});
...
var _excluded63 = ["className", "component", "children", "animation", "overlay", "loading", "variant", "level", "height", "width", "sx", "slots", "slotProps"];
...
var SkeletonRoot = styled_default("span", {
  ...
  ({
    ...
    var _a, _b, _c, _d, _e, _f;
    const defaultLevel = ((_c = (_b = (_a = theme.components) == null ? void 0 : _a.JoyTypography) == null ? void 0 : _b.defaultProps) == null ? void 0 : _c.level) || "body1";
    return [{
      display: "block",
      position: "relative",
      ...
      paddingBlockStart: `calc((${((_d = theme.typography[ownerState.level || defaultLevel]) == null ? void 0 : _d.lineHeight) || 1} - 1) * 0.56em)`,
      paddingBlockEnd: `calc((${((_e = theme.typography[ownerState.level || defaultLevel]) == null ? void 0 : _e.lineHeight) || 1} - 1) * 0.44em)`,
      "&::before": _extends({
        height: "1em"
      ...
      "&::after": _extends({
        height: "1em",
        top: `calc((${((_f = theme.typography[ownerState.level || defaultLevel]) == null ? void 0 : _f.lineHeight) || 1} - 1) * 0.56em)`
...
var Skeleton = React81.forwardRef(function Skeleton2(inProps, ref) {
  ...
  return loading ? (0, import_jsx_runtime68.jsx)(SlotRoot, _extends({}, rootProps, {
    children
  })) : (0, import_jsx_runtime68.jsx)(React81.Fragment, {
...
var _excluded64 = ["aria-label", "aria-valuetext", "className", "classes", "disableSwap", "disabled", "defaultValue", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "onMouseDown", "orientation", "shiftStep", "scale", "step", "tabIndex", "track", "value", "valueLabelDisplay", "valueLabelFormat", "isRtl", "color", "size", "variant", "component", "slots", "slotProps"];
function Identity(x) {
  return x;
}
...
var sliderColorVariables = ({
  ...
  var _a;
  const styles = ((_a = theme.variants[`${ownerState.variant}${data.state || ""}`]) == null ? void 0 : _a[ownerState.color]) || {};
...
var SliderThumb = styled_default("span", {
  ...
  return _extends({
    ...
    [theme.focus.selector]: _extends({}, theme.focus.default, {
      ...
      outlineColor: `rgba(${(_b = (_a = theme.vars.palette) == null ? void 0 : _a[ownerState.color]) == null ? void 0 : _b.mainChannel} / 0.32)`
    })
  }, ownerState.orientation === "horizontal" && {
    top: "50%",
    transform: "translate(-50%, -50%)"
...
var Slider = React82.forwardRef(function Slider2(inProps, ref) {
  ...
  return (0, import_jsx_runtime69.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime69.jsx)(SlotRail, _extends({}, railProps)), (0, import_jsx_runtime69.jsx)(SlotTrack, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (0, import_jsx_runtime69.jsxs)(React82.Fragment, {
      ...
      const style = axisProps[axis].offset(percent);
      return (0, import_jsx_runtime69.jsxs)(SlotThumb, _extends({
        "data-index": index
      }, thumbProps, {
...
var _excluded65 = ["anchorOrigin", "animationDuration", "autoHideDuration", "color", "children", "className", "component", "disableWindowBlurListener", "endDecorator", "invertedColors", "onBlur", "onClose", "onFocus", "onMouseEnter", "onMouseLeave", "onUnmount", "open", "resumeHideDuration", "size", "slots", "slotProps", "startDecorator", "variant"];
...
var Snackbar = React83.forwardRef(function Snackbar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime70.jsx)(SlotClickAway, _extends({
    ...
    children: (0, import_jsx_runtime70.jsxs)(SlotRoot, _extends({}, rootProps, {
      children: [startDecorator && (0, import_jsx_runtime70.jsx)(SlotStartDecorator, _extends({}, startDecoratorProps, {
        children: startDecorator
      })), children, endDecorator && (0, import_jsx_runtime70.jsx)(SlotEndDecorator, _extends({}, endDecoratorProps, {
        children: endDecorator
      }))]
    }))
  }));
...
var _excluded66 = ["className", "component", "size", "children", "orientation", "slots", "slotProps"];
...
var _excluded67 = ["active", "completed", "className", "component", "children", "disabled", "orientation", "indicator", "slots", "slotProps"];
...
var Step = React85.forwardRef(function Step2(inProps, ref) {
  ...
  return (0, import_jsx_runtime72.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime72.jsx)(SlotIndicator, _extends({}, indicatorProps, {
      children: indicator
    })), children]
  }));
});
...
var _excluded68 = ["className", "component", "children", "slots", "slotProps"];
...
var _excluded69 = ["className", "component", "color", "children", "variant", "slots", "slotProps"];
...
var _excluded70 = ["checked", "defaultChecked", "disabled", "onBlur", "onChange", "onFocus", "onFocusVisible", "readOnly", "required", "id", "color", "variant", "size", "startDecorator", "endDecorator", "component", "slots", "slotProps"];
...
var SwitchRoot = styled_default("div", {
  ...
  return _extends({
    "--Icon-color": "currentColor",
    "--variant-borderWidth": (_b = (_a = theme.variants[ownerState.variant]) == null ? void 0 : _a[ownerState.color]) == null ? void 0 : _b["--variant-borderWidth"],
...
var Switch = React88.forwardRef(function Switch2(inProps, ref) {
  ...
  const useSwitchProps = _extends({
    disabled: inProps.disabled ?? (formControl == null ? void 0 : formControl.disabled) ?? disabledExternalProp
  }, props);
  const {
    getInputProps,
    checked,
  ...
  return (0, import_jsx_runtime75.jsxs)(SlotRoot, _extends({}, rootProps, {
    ...
    })), (0, import_jsx_runtime75.jsxs)(SlotTrack, _extends({}, trackProps, {
...
var _excluded71 = ["action", "children", "value", "disabled", "onChange", "onClick", "onFocus", "component", "orientation", "variant", "color", "disableIndicator", "indicatorPlacement", "indicatorInset", "slots", "slotProps"];
...
var Tab = React89.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime76.jsx)(ListItemButtonOrientationContext_default.Provider, {
    value: orientation,
...
var _excluded72 = ["className", "component", "children", "borderAxis", "hoverRow", "noWrap", "size", "variant", "color", "stripe", "stickyHeader", "stickyFooter", "slots", "slotProps"];
...
var TableRoot = styled_default("table", {
  ...
  return [_extends({
    ...
    "--TableCell-borderColor": (variantStyle == null ? void 0 : variantStyle.borderColor) ?? theme.vars.palette.divider,
    ...
    md: "sm",
    lg: "md"
  }[ownerState.size]}`], (_b = theme.variants[ownerState.variant]) == null ? void 0 : _b[ownerState.color], {
    "& caption": {
      color: theme.vars.palette.text.tertiary,
  ...
  }), (((_c = ownerState.borderAxis) == null ? void 0 : _c.startsWith("x")) || ((_d = ownerState.borderAxis) == null ? void 0 : _d.startsWith("both"))) && {
  ...
  }, (((_e = ownerState.borderAxis) == null ? void 0 : _e.startsWith("y")) || ((_f = ownerState.borderAxis) == null ? void 0 : _f.startsWith("both"))) && {
...
var Table = React90.forwardRef(function Table2(inProps, ref) {
  ...
  return (0, import_jsx_runtime77.jsx)(TypographyInheritContext.Provider, {
    value: true,
    children: (0, import_jsx_runtime77.jsx)(SlotRoot, _extends({}, rootProps, {
      children
    }))
  });
});
...
var _excluded73 = ["component", "children", "variant", "color", "size", "disableUnderline", "underlinePlacement", "tabFlex", "sticky", "slots", "slotProps"];
...
var TabList = React92.forwardRef(function TabList2(inProps, ref) {
  ...
  return (
    ...
    (0, import_jsx_runtime78.jsx)(SlotRoot, _extends({}, rootProps, {
      children: (0, import_jsx_runtime78.jsx)(TabsListProvider, {
        value: contextValue,
        children: (0, import_jsx_runtime78.jsx)(ListProvider_default, {
          row: orientation === "horizontal",
          nested: true,
          children
        })
...
var _excluded74 = ["children", "value", "component", "color", "variant", "size", "slots", "slotProps", "keepMounted"];
...
var _excluded75 = ["children", "value", "defaultValue", "orientation", "direction", "component", "onChange", "selectionFollowsFocus", "variant", "color", "size", "slots", "slotProps"];
...
var TabsRoot = styled_default("div", {
  ...
  return _extends({}, ownerState.size === "sm" && {
    ...
    backgroundColor: theme.vars.palette.background.surface,
    position: "relative"
  }, theme.typography[`body-${ownerState.size}`], (_b = theme.variants[ownerState.variant]) == null ? void 0 : _b[ownerState.color], p !== void 0 && {
    "--Tabs-padding": p
  }, padding !== void 0 && {
...
var Tabs = React94.forwardRef(function Tabs2(inProps, ref) {
  ...
  return (
    ...
    (0, import_jsx_runtime80.jsx)(SlotRoot, _extends({}, rootProps, {
      children: (0, import_jsx_runtime80.jsx)(TabsProvider, {
        value: contextValue,
        children: (0, import_jsx_runtime80.jsx)(SizeTabsContext_default.Provider, {
          value: size,
          children
        })
      })
...
var _excluded76 = ["propsToForward", "rootStateClasses", "inputStateClasses", "getRootProps", "getInputProps", "formControl", "focused", "error", "disabled", "size", "color", "variant", "startDecorator", "endDecorator", "minRows", "maxRows", "component", "slots", "slotProps"];
...
var Textarea = React95.forwardRef(function Textarea2(inProps, ref) {
  ...
  const _useForwardedInput = useForwardedInput(props, textareaClasses_default), {
    ...
    slots = {},
    slotProps = {}
  } = _useForwardedInput, other = _objectWithoutPropertiesLoose(_useForwardedInput, _excluded76);
  if (true) {
    const registerEffect = formControl == null ? void 0 : formControl.registerEffect;
    React95.useEffect(() => {
      if (registerEffect) {
  ...
  return (0, import_jsx_runtime81.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [startDecorator && (0, import_jsx_runtime81.jsx)(SlotStartDecorator, _extends({}, startDecoratorProps, {
      children: startDecorator
    })), (0, import_jsx_runtime81.jsx)(SlotTextarea, _extends({}, textareaProps)), endDecorator && (0, import_jsx_runtime81.jsx)(SlotEndDecorator, _extends({}, endDecoratorProps, {
      children: endDecorator
    }))]
  }));
});
...
var _excluded77 = ["buttonFlex", "className", "component", "disabled", "size", "color", "variant", "children", "onChange", "orientation", "slots", "slotProps", "spacing", "value"];
...
var ToggleButtonGroup = React96.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime82.jsx)(SlotRoot, _extends({}, rootProps, {
    children: (0, import_jsx_runtime82.jsx)(ToggleButtonGroupContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime82.jsx)(ButtonGroupContext_default.Provider, {
        value: buttonGroupContext,
...
var Tooltip = React97.forwardRef(function Tooltip2(inProps, ref) {
  ...
  return (0, import_jsx_runtime83.jsxs)(React97.Fragment, {
    children: [React97.isValidElement(children) && React97.cloneElement(children, childrenProps), (0, import_jsx_runtime83.jsxs)(SlotRoot, _extends({}, rootProps, !((_a = props.slots) == null ? void 0 : _a.root) && {
      as: Popper,
      slots: {
        root: component || "div"
      }
    }, {
      children: [title, arrow ? (0, import_jsx_runtime83.jsx)(SlotArrow, _extends({}, arrowProps)) : null]
    }))]
  });
});
