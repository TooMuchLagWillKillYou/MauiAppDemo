...
const useFetchPizzas = () => {
    return useQuery({
        queryKey: ["pizzas"],
        queryFn: () =>
            axios.get(`${config.baseApiUrl}/pizzas`)
...
const useAddPizza = () => {
    ...
    return useMutation({
        mutationFn: (pizza) =>
            axios.post(`${config.baseApiUrl}/pizzas`, pizza),
        onSuccess: () => {
...
const useUpdatePizza = () => {
    ...
    return useMutation({
        mutationFn: (pizza) =>
            axios.put(`${config.baseApiUrl}/pizzas`, pizza),
        onSuccess: () => {
            queryClient.invalidateQueries({
                queryKey: ["pizzas"],
            });
...
const useDeletePizza = () => {
    ...
    return useMutation({
        mutationFn: (id) =>
            axios.delete(`${config.baseApiUrl}/pizzas/${id}`),
        onSuccess: () => {
            queryClient.invalidateQueries({
                queryKey: ["pizzas"],
            });
